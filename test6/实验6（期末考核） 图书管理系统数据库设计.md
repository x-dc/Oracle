...
```sql
-- 创建恢复目录
create tablespace bp datafile 'D:/Users/41743/Desktop/oradata/ORCLbp.dbf' size 20m autoextend on next 5m maxsize unlimited;
-- 在恢复目录数据库中创建RMAN用户并授权
create user c##_XDC_user1 identified by zytzyt1 default tablespace1 bp quota unlimited on bp;
